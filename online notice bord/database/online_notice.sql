...
///.....to create data content for video and page description
CREATE TABLE `online_notice`.`cprog` ( `id` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(250) NOT NULL , `location` VARCHAR(250) NOT NULL , `description` TEXT NOT NULL , `subject` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
